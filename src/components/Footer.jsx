    ...
    <div className="container">
      <div className='w-full flex flex-col items-center gap-y-[19px] pt-[55px]'>
        ...
        <div className=' hidden sm:flex w-[115.21px] lg:w-[234.46px] sm:w-[166.73px] justify-between'>
          <i className='bx bxl-instagram sm:text-[20px] lg:text-[25px]'><BsInstagram /></i>
          <i className='bx bxl-linkedin sm:text-[20px] lg:text-[25px]'><FaLinkedinIn /></i>
          <i className='bx bxl-facebook sm:text-[20px] lg:text-[25px]'><FaFacebookSquare /></i>
          <i className='bx bxl-twitter sm:text-[20px] lg:text-[25px]'><FaTwitterSquare /></i>
          </div>
        </div>
      </div>
    </div>
